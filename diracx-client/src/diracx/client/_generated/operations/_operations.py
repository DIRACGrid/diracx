...
def build_pilots_create_pilot_secrets_request(
    **kwargs: Any,
    ...
    # Construct URL
    _url = "/api/pilots/fields/secrets"
...
def build_pilots_associate_pilots_with_secrets_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pilots_search_request(
    *, page: int = 1, per_page: int = 100, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_pilots_get_logs_request(*, pilot_id: int, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PilotsOperations:
    ...
    def create_pilot_secrets(
        self,
        body: Union[_models.BodyPilotsCreatePilotSecrets, IO[bytes]],
        **kwargs: Any,
    ) -> List[_models.PilotSecretsInfo]:
        """Create Pilot Secrets.
    ...
    @overload
    def associate_pilots_with_secrets(
        self,
        body: _models.BodyPilotsAssociatePilotsWithSecrets,
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> None:
    ...
    @distributed_trace
    def associate_pilots_with_secrets(  # pylint: disable=inconsistent-return-statements
        self,
        ...
        **kwargs: Any,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "BodyPilotsAssociatePilotsWithSecrets")

        _request = build_pilots_associate_pilots_with_secrets_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
    ...
    @distributed_trace
    def get_logs(self, *, pilot_id: int, **kwargs: Any) -> List[Dict[str, Any]]:
        """Get Logs.
