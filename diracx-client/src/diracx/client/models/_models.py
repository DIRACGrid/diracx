...
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.2, generator: @autorest/python@6.22.0)
...
class Metadata(_serialization.Model):
    ...
    :ivar development_settings: Settings for the Development Configuration that can influence run
     time. Required.
    :vartype development_settings: ~client.models.DevelopmentSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :keyword development_settings: Settings for the Development Configuration that can influence
         run time. Required.
        :paramtype development_settings: ~client.models.DevelopmentSettings
        """
        super().__init__(**kwargs)
