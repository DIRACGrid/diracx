...
# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.0, generator: @autorest/python@6.4.11)
...
def build_jobs_assign_sandbox_request(
...
class JobsOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def assign_sandbox(self, job_id: int, body: str, **kwargs: Any) -> Any:
        """Assign Sandbox.
