...
def upgrade() -> None:
    ...
    op.create_table('JobsHistorySummary',
    ...
    sa.UniqueConstraint('Status', 'Site', 'Owner', 'OwnerGroup', 'VO', 'JobGroup', 'JobType', 'ApplicationStatus', 'MinorStatus', name='uq_summary')
    )
    ...
    sa.Column('VerifiedFlag', diracx.db.sql.utils.types.EnumBackedBool(), nullable=False),
    sa.Column('AccountedFlag', diracx.db.sql.job.schema.AccountedFlagEnum(), nullable=False),
    ...
    op.create_table('AtticJobParameters',
    sa.Column('JobID', sa.Integer(), nullable=False),
    ...
    op.create_table('HeartBeatLoggingInfo',
    sa.Column('JobID', sa.Integer(), nullable=False),
    sa.Column('Name', sa.String(length=100), nullable=False),
    sa.Column('Value', sa.Text(), nullable=False),
    ...
    op.create_table('OptimizerParameters',
    sa.Column('JobID', sa.Integer(), nullable=False),
    sa.Column('Name', sa.String(length=100), nullable=False),
    sa.Column('Value', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['JobID'], ['Jobs.JobID'], ondelete='CASCADE'),
