...
class Trigger:
    ...
    def __init__(
        self, name: str, when: str, action: str, table: str, time: str, body: str
    ):
        self.name: str = name
        self.when: str = when
...
#
# This function tells Alembic how to compare the state of the sqlalchemy metadata
...
def compare_triggers(autogen_context, operations, schemas):
    ...
    for trigger in metadata_triggers:
        ...
        operations.ops.append(CreateTriggerOp(trigger))
    ...
    for trigger in all_conn_triggers:
        ...
        operations.ops.append(DropTriggerOp(trigger))
