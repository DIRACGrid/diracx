...
async def submit_bulk_jobs(
    ...
    for (
        ...
        job_desc_list
    ):  # job_desc_list because there might be a list generated by a parametric job
...
async def delete_bulk_jobs(
    ...
    except* JobNotFoundError as group_exc:
...
async def reschedule_bulk_jobs(
    ...
    for job_id in valid_job_list:
        ...
        result = await job_db.reschedule_job(job_id)
        try:
