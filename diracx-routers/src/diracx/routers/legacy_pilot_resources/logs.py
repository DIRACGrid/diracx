"""File dedicated to legacy pilot resources: pilots with DIRAC auth, without JWT."""
...
from .access_policies import (
    CheckLegacyPilotPolicyCallable,
)
...
async def send_message(
    ...
    pilot_stamp: Annotated[
        str,
        Body(
            description="PilotStamp, required as legacy pilots do not have a token with stamp in it."
        ),
    ],
    pilot_logs_db: PilotLogsDB,
    pilot_db: PilotAgentsDB,
    check_permissions: CheckLegacyPilotPolicyCallable,
