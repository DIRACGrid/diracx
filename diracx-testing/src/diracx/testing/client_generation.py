...
def strip_autorest_version_comments(generated_dir: Path):
    """Strip version-specific info from autorest-generated file headers.

    This avoids noisy diffs when autorest versions are bumped.
    """
    pattern = re.compile(
        r"# Code generated by Microsoft \(R\) AutoRest Code Generator \(autorest:.*?\)"
    )
    replacement = "# Code generated by Microsoft (R) AutoRest Code Generator."
...
def regenerate_client(openapi_spec: Path, client_module: str):
    ...
    strip_autorest_version_comments(generated_dir)
