...
class PilotsOperations:
    ...
    async def send_message(
        self, body: _models.LogMessage, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Send Message.
    ...
    @distributed_trace_async
    async def send_message(self, body: Union[_models.LogMessage, IO[bytes]], **kwargs: Any) -> None:
        """Send Message.
