...
def build_auth_perform_secret_exchange_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pilots_summary_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pilots_internal_userinfo_request(*, authorization: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/api/pilots/internal/pilotinfo"
...
def build_pilots_internal_send_message_request(  # pylint: disable=name-too-long
    *, authorization: Optional[str] = None, **kwargs: Any
    ...
    content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    # Construct URL
    _url = "/api/pilots/internal/message"
...
class AuthOperations:  # pylint: disable=abstract-class-instantiated
    ...
    def refresh_pilot_tokens(
        self, body: _models.BodyAuthRefreshPilotTokens, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.TokenResponse:
...
class PilotsInternalOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~_generated.Dirac`'s
        :attr:`pilots_internal` attribute.
    """
    ...
    def userinfo(self, *, authorization: Optional[str] = None, **kwargs: Any) -> _models.PilotInfo:
        ...
        _request = build_pilots_internal_userinfo_request(
    ...
    def send_message(
        self,
        body: _models.BodyPilotsInternalSendMessage,
        *,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~_generated.models.BodyPilotsInternalSendMessage
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def send_message(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.BodyPilotsInternalSendMessage, IO[bytes]],
        *,
        authorization: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :param body: Is either a BodyPilotsInternalSendMessage type or a IO[bytes] type. Required.
        :type body: ~_generated.models.BodyPilotsInternalSendMessage or IO[bytes]
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :return: None
        :rtype: None
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "BodyPilotsInternalSendMessage")

        _request = build_pilots_internal_send_message_request(
            authorization=authorization,
            content_type=content_type,
            json=_json,
            content=_content,
