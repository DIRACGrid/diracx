...
# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.4, generator: @autorest/python@6.32.0)
...
def build_pilots_get_pilot_info_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/api/pilots/info"
...
class PilotsOperations:
    ...
    @distributed_trace
    def get_pilot_info(self, **kwargs: Any) -> Any:
        """Get Pilot Info.
