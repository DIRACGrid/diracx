...
from typing import IO, Any, Dict, List, Optional, TypeVar, Union, overload
...
class AuthOperations:
    ...
    async def authorization_flow(
        self,
        *,
        response_type: str | _models.Enum2,
        code_challenge: str,
        code_challenge_method: str | _models.Enum3,
        client_id: str,
        redirect_uri: str,
        scope: str,
        state: str,
...
class ConfigOperations:
    ...
    async def serve_config(
        self, vo: str, *, if_none_match: str | None = None, if_modified_since: str | None = None, **kwargs: Any
    ) -> Any:
        """Serve Config.
...
class JobsOperations:
    ...
    @distributed_trace_async
    async def submit_bulk_jobs(self, body: list[str] | IO, **kwargs: Any) -> list[_models.InsertedJob]:
        """Submit Bulk Jobs.
        ...
        content_type: str | None = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    @distributed_trace_async
    async def get_single_job_status(self, job_id: int, **kwargs: Any) -> str | _models.JobStatus:
        ...
        cls: ClsType[str | _models.JobStatus] = kwargs.pop("cls", None)
    ...
    @distributed_trace_async
    async def set_single_job_status(self, job_id: int, *, status: str | _models.JobStatus, **kwargs: Any) -> Any:
    ...
    @distributed_trace_async
    async def set_status_bulk(
        self, body: list[_models.JobStatusUpdate] | IO, **kwargs: Any
    ) -> list[_models.JobStatusReturn]:
        """Set Status Bulk.
    ...
    async def search(
        self,
        body: _models.JobSearchParams | None = None,
        *,
        page: int = 0,
        per_page: int = 100,
    ...
    @distributed_trace_async
    async def search(
        self, body: _models.JobSearchParams | IO | None = None, *, page: int = 0, per_page: int = 100, **kwargs: Any
    ) -> list[JSON]:
        """Search.
    ...
    @distributed_trace_async
    async def summary(self, body: _models.JobSummaryParams | IO, **kwargs: Any) -> Any:
        """Summary.
