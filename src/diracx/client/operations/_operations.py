...
from typing import IO, Any, Dict, Optional, TypeVar, Union, overload
...
def build_jobs_set_single_job_status_request(
    job_id: int, *, status: str | _models.JobStatus, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JobsOperations:
    ...
    @distributed_trace
    def submit_bulk_jobs(self, body: list[str] | IO, **kwargs: Any) -> list[_models.InsertedJob]:
        """Submit Bulk Jobs.
    ...
    @distributed_trace
    def get_single_job_status(self, job_id: int, **kwargs: Any) -> str | _models.JobStatus:
    ...
    @distributed_trace
    def set_single_job_status(self, job_id: int, *, status: str | _models.JobStatus, **kwargs: Any) -> Any:
    ...
    @distributed_trace
    def set_status_bulk(self, body: list[_models.JobStatusUpdate] | IO, **kwargs: Any) -> list[_models.JobStatusReturn]:
        """Set Status Bulk.
    ...
    def search(
        self,
        body: _models.JobSearchParams | IO | None = None,
        *,
        page: int = 0,
        per_page: int = 100,
        **kwargs: Any,
    ...
    @distributed_trace
    def summary(self, body: _models.JobSummaryParams | IO, **kwargs: Any) -> Any:
        """Summary.
