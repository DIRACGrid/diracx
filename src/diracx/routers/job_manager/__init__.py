...
async def submit_bulk_jobs(
    ...
    sub = user_info.sub.split(":", 1)[1]
    fixme_ownerUsername = config.Registry[user_info.vo].Users[sub].PreferedUsername
    fixme_ownerDN = config.Registry[user_info.vo].Users[sub].DN[0]
    fixme_ownerGroup = user_info.dirac_group
